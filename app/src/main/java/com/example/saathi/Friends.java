...
public class Friends extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.home) {
            ...
            Intent intent=new Intent(Friends.this,RegisterCourses.class);
            startActivity(intent);

        } else if (id == R.id.timetable) {
            Intent intent=new Intent(Friends.this,Timetable.class);
            startActivity(intent);

        } else if (id == R.id.toDo) {
            Intent intent=new Intent(Friends.this,ToDo.class);
            startActivity(intent);
